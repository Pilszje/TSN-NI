...
module TSN_ep_lmb #(
    ...
    // lmb
    parameter [63:0] C_BASEADDR = 64'h20000,
    parameter [63:0] C_HIGHADDR = 64'h3FFFF, 
    parameter [63:0] C_MASK = 64'h20000, 
    parameter integer C_ADDRWIDTH = 32
    ...
    // lmb
    (* X_INTERFACE_INFO = "xilinx.com:interface:lmb:1.0 LMB_S ABUS" *)
    input wire [31:0] lmb_abus, // Address bus (required)
    (* X_INTERFACE_INFO = "xilinx.com:interface:lmb:1.0 LMB_S ADDRSTROBE" *)
    input wire lmb_addrstrobe, // Address strobe (required)
    (* X_INTERFACE_INFO = "xilinx.com:interface:lmb:1.0 LMB_S BE" *)
    input wire [3:0] lmb_be, // Byte enable (optional)
    (* X_INTERFACE_INFO = "xilinx.com:interface:lmb:1.0 LMB_S CE" *)
    output wire lmb_ce, // Correctable error (optional)
    (* X_INTERFACE_INFO = "xilinx.com:interface:lmb:1.0 LMB_S READDBUS" *)
    output wire [31:0] lmb_readdbus, // Read data bus (required)
    (* X_INTERFACE_INFO = "xilinx.com:interface:lmb:1.0 LMB_S READSTROBE" *)
    input wire lmb_readstrobe, // Read strobe (required)
    (* X_INTERFACE_INFO = "xilinx.com:interface:lmb:1.0 LMB_S READY" *)
    output wire lmb_ready, // Ready (required)
    // (* X_INTERFACE_INFO = "xilinx.com:interface:lmb:1.0 LMB_S RST" *)
    // input wire lmb_rst, // Reset (optional)
    (* X_INTERFACE_INFO = "xilinx.com:interface:lmb:1.0 LMB_S UE" *)
    output wire lmb_ue, // Uncorrectable error (optional)
    (* X_INTERFACE_INFO = "xilinx.com:interface:lmb:1.0 LMB_S WAIT" *)
    output wire lmb_wait, // Wait (optional)
    (* X_INTERFACE_INFO = "xilinx.com:interface:lmb:1.0 LMB_S WRITEDBUS" *)
    input wire [31:0] lmb_writedbus, // Write data bus (optional)
    (* X_INTERFACE_INFO = "xilinx.com:interface:lmb:1.0 LMB_S WRITESTROBE" *)
    input wire lmb_writestrobe // Write strobe (optional)
...
assign {lmb_ce,lmb_ue,lmb_wait} = 0;
wire rstn;
assign rstn = ~reset;

// i need to make sure i only do lmb bus access when its in range of my segment
localparam [C_ADDRWIDTH-1:0] ADDR_MASK = ((1<<C_ADDRWIDTH)-1) - ((1<<BYTE_ADDR_W)-1);
// localparam [C_ADDRWIDTH-1:0] ADDR_CHECK = C_BASEADDR[63: 64-C_ADDRWIDTH] & ADDR_MASK;


wire lmb_addrstrobe_int;
assign lmb_addrstrobe_int = (lmb_abus & ADDR_MASK) == C_BASEADDR[C_ADDRWIDTH-1:0];
...
`endif
    .s_abus(lmb_abus), // Address bus (required)
    .s_readstrobe(lmb_readstrobe), // Read strobe (required)
    .s_writestrobe(lmb_writestrobe), // Write strobe (optional)
    .s_addrstrobe(lmb_addrstrobe_int), // Address strobe (required)
    .s_writedbus(lmb_writedbus), // Write data bus (optional)
    .s_ready(lmb_ready), // Ready (required)
    .s_readdbus(lmb_readdbus) // Read data bus (required)
);
