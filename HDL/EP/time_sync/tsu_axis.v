...
// can replace this, as its just two wrappers around an async fifo
// ptp_queue queue(
// .aclr(q_rst),
...
fifo_async #(
    ...
    .w_clk(q_wr_clk),
    .w_rstn(~q_rst),
    .w_we(q_wr_en && !q_wr_full),
    .r_clk(q_rd_clk),
    .r_rstn(~q_rst),
    .r_re(q_rd_en && !q_rd_empty),
    .w_din(q_wr_data),
    .r_dout(q_rd_data),
    .r_empty(q_rd_empty),
    .w_full(q_wr_full)
...
assign q_rd_stat = 0; // usedw show the number of words used in the fifo
endmodule
